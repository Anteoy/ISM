...
(function(a) {
	...
	a.extend({
		tmpl : function(d, h, e, c) {
			...
			i = a.isArray(h) ? a.map(h, function(a, i) {
				if (a) {
					a._index = i;
					return g(e, c, d, a);
				} else {
	...
	function o(b) {
		var content = "var $=jQuery,call,__=[],$data=$item.data;with($data){__.push('"
			+ a
			.trim(b)
			.replace(/([\\'])/g, "\\$1")
			.replace(/[\r\t\n]/g, " ")
								...
								+ j[l ? "close" : "open"]
										...
										.join(
												g
														|| i.$2
														|| "")
								+ (k != "else" && (l || j.close == undefined) ? "}catch(e){if(e.message.indexOf('undefined')==-1 && e.message.indexOf('未定义')==-1 && e.message.indexOf(' of null')==-1)throw e;}" : "")
								+ "__.push('";
					}) + "');}return __;";
		return new Function(
				"jQuery",
